...
mod test {
    ...
    impl<E: Engine> Circuit<E> for TestReinforcementConcreteCircuit<E> {
        ...
        fn declare_used_gates() -> Result<Vec<Box<dyn GateInternal<E>>>, SynthesisError> {
            Ok(vec![Width4MainGateWithDNext::default().into_internal(), Rescue5CustomGate::default().into_internal()])
        }
        ...
        fn synthesize<CS: ConstraintSystem<E>>(&self, cs: &mut CS) -> Result<(), SynthesisError> {
            ...
            let alphas: [E::Fr; 2] = { self.params.alphas.iter().map(|x| from_u64::<E::Fr>(*x as u64)).collect::<Vec<_>>().try_into().unwrap() };
            ...
            let mut rc_gadget = ReinforcementConcreteGadget::new(cs, alphas, betas, p_prime, s_arr, perm_f, false)?;
    ...
    fn rc_gadget_test_template<E: DefaultRcParams>(is_const_test: bool) {
        ...
        let mut assembly = TrivialAssembly::<E, PlonkCsWidth4WithNextStepParams, Width4MainGateWithDNext>::new();
