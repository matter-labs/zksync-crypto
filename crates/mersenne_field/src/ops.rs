...
#[inline(always)]
pub(crate) const fn reduce_with_division(value: u32) -> u32 {
    core::intrinsics::const_eval_select((value,), reduce_with_division_ct, reduce_with_division_rt_riscv)
}
...
#[cfg(all(target_arch = "riscv32", feature = "use_division", feature = "modular_ops"))]
#[inline(always)]
fn reduce_with_division_rt_riscv(value: u32) -> u32 {
...
fn sub_mod_rt_riscv(a: u32, b: u32) -> u32 {
    reduce_with_division_rt_riscv(crate::Mersenne31Field::ORDER.wrapping_add(a).wrapping_sub(b))
}
